...
"""
A librairie to provides class and functions to make it easier dialog box in terminal.
"""
...
def main(stdscr):
    ...
    for reply in text:
        ...
        # ~ textbox.word_by_word(stdscr, reply, 2, delay=0.21, random_delay=(0.2, 0.3))
