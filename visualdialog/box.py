...
from utils import CursesTextAttributesConstants, TextAttributes
...
class TextBox:
    ...
    title_colors_pair_nb : CursesTextAttributesConstants, optional
    ...
    title_text_attributes : list or tuple of CursesTextAttributesConstants, optional
        Dialog box title text attributes (by default a tuple contains
        curses.A_BOLD).
    downtime_chars : list of str or tuple of str, optional
    ...
    Class attributes
    ----------------
    confirm_dialog_key : list or tuple
